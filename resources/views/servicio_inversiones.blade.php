  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="{{asset('images/services/inversiones.jpg')}}" class="img-fluid w-100">
      </div>
    </div>
    <!-- course info -->
    ...
    <div class="row">
      ...
      <div class="col-12 mb-4">
        <h3 class="mb-3">Iniciativas Privadas (asesorías)</h3>
        <ul class="list-styled">
      ...
      <div class="col-12 mb-4">
        <h3 class="mb-3">Estudios de preinversión y definitivos</h3>
        <ul class="list-styled">
