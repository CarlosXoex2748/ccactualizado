...
<section class="section-sm">
  <div class="container">
    ...
    <div class="row align-items-center">
      <div class="col-12 order-1 col-sm-6 mb-4 mb-xl-0">
        <h2 data-aos="fade-right" data-aos-duration="2000">Política y Gestión pública</h2>
      </div>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        ...
        <p data-aos="fade-right" data-aos-duration="2000">Políticas públicas, estrategias y acciones sustentables en educación, salud e infraestructura. Sustentabilidad y finanzas públicas.</p>
      </div>
      <div class="col-6 mb-4">
        <h3 class="mb-3" data-aos="fade-right" data-aos-duration="2000">Gestión y políticas públicas</h3>
        ...
        <div class="col-6 mb-4" data-aos="zoom-in" data-aos-duration="2000">
          <!-- course thumb -->
          <img src="{{asset('images/services/gestion_publica.jpg')}}" class="img-fluid w-100 zoom-out">
        </div>
    
            
      <div class="col-8 mb-4" data-aos="fade-right" data-aos-duration="2000">
